...
class MostRatedDoctorsAdapter(private val onItemClick: OnItemClick) :
    RecyclerView.Adapter<MostRatedDoctorsAdapter.MostRatedDoctorsViewHolder>() {
    ...
    class MostRatedDoctorsViewHolder(val binding: ItemDoctorBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MostRatedDoctorsAdapter.MostRatedDoctorsViewHolder {
        val binding =
            ItemDoctorBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MostRatedDoctorsAdapter.MostRatedDoctorsViewHolder(binding)
    }

    override fun onBindViewHolder(
        holder: MostRatedDoctorsAdapter.MostRatedDoctorsViewHolder,
        position: Int
    ) {
